# **PLAN FINAL DU MÉMOIRE DE MASTER (RECHERCHE)**
...
* Annexe A : Détails d'implémentation
* Annexe B : Hyperparamètres des modèles
* Annexe C : Scénarios de simulation
* Annexe D : Architecture logicielle et structure du projet
* Annexe E : Interfaces et démonstrations
