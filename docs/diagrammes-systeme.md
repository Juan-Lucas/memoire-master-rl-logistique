...
### Exemple de structure
```
| Méthode      | Productivité | Attente | Consommation | Util. Camions | Score |
|--------------|--------------|---------|--------------|---------------|-------|
| PPO          | 8000         | 3.2     | 0.85         | 82%           | 9.2   |
| DQN          | 7800         | 3.5     | 0.87         | 80%           | 8.8   |
| Q-Learning   | 7200         | 3.8     | 0.89         | 77%           | 7.5   |
| SARSA        | 7100         | 3.9     | 0.90         | 76%           | 7.2   |
| Shortest Path| 7300         | 4.3     | 0.88         | 78%           | 7.8   |
| FIFO         | 6950         | 4.1     | 0.91         | 75%           | 7.0   |
| Nearest Shovel| 7100        | 3.9     | 0.89         | 76%           | 7.3   |
| Fixed Assign.| 6500         | 4.8     | 0.94         | 70%           | 6.5   |
```
